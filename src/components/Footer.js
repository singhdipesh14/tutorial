    ...
    return (
      <div className="footer">
        <div className="facebook">
          ...
          />
          <div className="copyright">Copyright © 2020 Facebook Inc.</div>
        </div>
        <div className="links1">
          <div id="linktitle">DOCS</div>
          ...
          <a href="#">FAQ</a>
          <div id="linktitle">COMMUNITY</div>
          <a href="#">Code of Conduct</a>
          <a href="#">Community Resources</a>
        </div>
        <div className="links2">
          <div id="linktitle">CHANNELS</div>
          <a href="#">GitHub</a>
